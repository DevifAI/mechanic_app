...
const equipmentInData: EquipmentInItem[] = [
  {
    ...
    items: [
      ...
      { equipment: 'Hammer Drill', quantity: 5, uom: 'pcs', notes: 'For concrete work' },
    ],
  ...
  },
  {
    ...
    date: '2025-05-03',
    items: [
      { equipment: 'Bulldozer', quantity: 1, uom: 'pcs', notes: 'Transfer to site' },
    ],
    accountManagerApproval: 'approved',
  ...
  },
  {
    ...
    date: '2025-05-04',
    items: [
      { equipment: 'Generator', quantity: 1, uom: 'pcs', notes: 'Returned from site' },
    ],
...
const filteredEquipmentInData = equipmentInData.filter(item => {
    ...
    <View style={styles.card}>
      <View style={styles.cardContent}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ViewItems', { document: item, ScreenType: 'equipmentin' })}
        >
